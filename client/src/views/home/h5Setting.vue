        ...
        >
          <template v-for="(comp, idx) in compList">
            ...
            <div
              ...
              :style="{ border: comp.active ? '1px solid ' + getThemeHeaderBGColor : '' }"
              :key="idx"
              :data-index="idx"
...
import AppSidebar from '@/components/h5Setting/slidebar.vue'
import AppToolbar from '@/components/h5Setting/toolbar.vue'
